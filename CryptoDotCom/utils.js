...
const cardGenerator = (data, nameCla, logoCla, priceCla, varCla) => {
  ...
  textEl.append(name, price, priceChange);
  card.append(rank, logo, textEl);
  return card;
};
